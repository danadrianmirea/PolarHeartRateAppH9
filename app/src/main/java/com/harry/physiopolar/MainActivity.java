...
public class MainActivity extends Activity implements OnItemSelectedListener, Observer {
    ...
    public void writeData(String polarData) {
        ...
        String filename = "phySense_" + new SimpleDateFormat("yyyyMMdd_HHmm'.csv'").format(new Date());
        File sdcard = Environment.getExternalStorageDirectory();
        File dir = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/PhysioSENSE/");
    ...
    public void sendData(String polarData) {
        ...
        String udpMsg = "timestamp" + ", " + timeStamp + ", " + "bpm" + ", " + polarData;
